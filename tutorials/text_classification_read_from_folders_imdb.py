...
train_data = load_files(r"data/aclImdb/train")
train_examples, train_labels = np.asarray(train_data.data), np.asarray(train_data.target)

test_data = load_files(r"data/aclImdb/test")
test_examples, test_labels = np.asarray(test_data.data), np.asarray(test_data.target)
